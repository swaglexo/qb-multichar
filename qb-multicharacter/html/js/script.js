    ...
    if (MR.Characters.CurrentPage === 'firstname') {
        ...
        setTimeout(() => {
            ...
            if (MR.Characters.CurrentPage === 'birthdate') {
                ...
                $("#next-text").html('Next');
                $("#next-text-description").html('Продължи');
            }
...
$(document).on('click', '.next-button', function(e) {    
    ...
    if (MR.Characters.CurrentPage === 'gender') {
        $("."+MR.Characters.CurrentPage).fadeOut(150);
        $(".character-register-new-content").fadeOut(150);
        $(".char-waiting-spinner").find('p').html('Създавате герой');
        $(".char-waiting-spinner").fadeIn(150);
        setTimeout(() => {
            $(".char-waiting-spinner").fadeOut(50);
            // Create Char
...
$(document).on('click', '.character', function(e) {    
    ...
    if (MR.Characters.SelectedChar === null) {
        ...
        if ((MR.Characters.SelectedChar).data('cid') == "") {
            ...
            // MAKE CHAR TEXT
            $("#play-text").html("Създай");
            $("#play-text-description").html("Създай Герой");
...
MR.Characters.Functions.Refresh = function() {
    $('.characters-list').html(
        '<div class="character-list-header"><p>NOSAD 1.0</p></div><div class="character-list-header-select"><p>Избери герой</p></div> <div class="character" id="char-1" data-cid=""> <span id="slot-icon"><i class="fas fa-user fa-3x"></i></span> <span id="slot-name">Избери слот</span></span> <span id="slot-name-description">No data...</span></span> </div> <div class="character" id="char-2" data-cid=""> <span id="slot-icon"><i class="fas fa-user fa-3x"></i></span> <span id="slot-name">Избери слот</span></span> <span id="slot-name-description">No data...</span></span> </div> <div class="character" id="char-3" data-cid=""> <span id="slot-icon"><i class="fas fa-user fa-3x"></i></span> <span id="slot-name">Избери слот</span></span> <span id="slot-name-description">No data...</span></span> </div> <div class="character" id="char-4" data-cid=""> <span id="slot-icon"><i class="fas fa-user fa-3x"></i></span> <span id="slot-name">Избери слот</span></span> <span id="slot-name-description">No data...</span></span> </div>' +
